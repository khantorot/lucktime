...
window.addEventListener('scroll', function () {
	...
	if (!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))) {
		...
		if (scrolled >= 200) {
			document.querySelector('.circular_wrap').classList.add('circular_wrap_active');
		} else {
			document.querySelector('.circular_wrap').classList.remove('circular_wrap_active');
		}
	}
	if (scrolled >= 400) {
...
var deadline = "Jule 30 2021 20:56:00 GMT+6";
